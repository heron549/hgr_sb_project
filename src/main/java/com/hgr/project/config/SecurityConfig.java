package com.hgr.project.config;
...
import com.hgr.project.TokenAuthenticationFilter;
...
public class SecurityConfig {
	...
	SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		http
			...
			.authorizeHttpRequests( ( a ) -> a.requestMatchers
				( new AntPathRequestMatcher("/lib/**") ).permitAll() )
			.authorizeHttpRequests( ( a ) -> a.requestMatchers
				( new AntPathRequestMatcher("/scss/**") ).permitAll() )
			.authorizeHttpRequests( ( a ) -> a.requestMatchers
